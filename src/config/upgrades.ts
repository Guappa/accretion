...
export const UPGRADE_NODES: UpgradeNode[] = assignCurvedCosts([
  ...
  { id: 'hub.timeOnKill', pathId: 'hub', clusterId: 'hubCore', gx: 3, gy: 3, icon: 'timeOnKill', name: 'Overtime', description: '20% chance a Breaker kill extends session time', prerequisites: ['hub.time2'], effects: { sessionTimeOnKillChanceFlat: 0.2 } },
  ...
  { id: 'golden.spawn', pathId: 'golden', clusterId: 'golden', gx: 0, gy: 0, icon: 'golden', name: 'Golden Asteroids', description: 'Any entity can spawn golden, a rare high-value affix', prerequisites: [], effects: { goldenSpawnChanceFlat: 0.08 }, keystone: true },
  ...
  { id: 'radioactive.spawn', pathId: 'radioactive', clusterId: 'radioactive', gx: 0, gy: 0, icon: 'radioactive', name: 'Radioactive Spawns', description: 'Entities can spawn radioactive; breaking one leaves a fallout zone that deals damage over time nearby', prerequisites: [], effects: { radioactiveSpawnChanceFlat: 0.06 }, keystone: true },
  ...
  { id: 'comet.flyby', pathId: 'comet', clusterId: 'comet', gx: 0, gy: 0, icon: 'comet', name: 'Comet Flybys', description: 'Comets periodically streak through, offering a bonus if destroyed in time', prerequisites: [], effects: {}, flags: ['comets'], keystone: true },
  ...
  { id: 'laser.beam', pathId: 'laser', clusterId: 'laser', gx: 0, gy: 0, icon: 'laser', name: 'Star Lasers', description: 'Stars can spawn laser-equipped - breaking one fires a beam across the entire field, damaging everything in its path', prerequisites: [], effects: { laserSpawnChanceFlat: 0.35, laserDamageFlat: 6 }, flags: ['laser'], keystone: true },
  ...
  { id: 'orb.spark', pathId: 'orb', clusterId: 'orb', gx: 0, gy: 0, icon: 'orb', name: 'Orbital Spark', description: 'Breaker kills have a chance to launch a bouncing orb that chains between nearby targets', prerequisites: [], effects: { orbChanceFlat: 0.2, orbDamageFlat: 6, orbBounceFlat: 2 }, flags: ['orbs'], keystone: true },
  ...
  { id: 'moon.capture', pathId: 'moon', clusterId: 'moon', gx: 0, gy: 0, icon: 'moon', name: 'Moon Capture', description: 'Entities can spawn with a moon affix; breaking one captures a satellite that orbits and buffs the Breaker', prerequisites: [], effects: { moonSpawnChanceFlat: 0.05 }, keystone: true },
...
export const UPGRADE_TRUNKS: UpgradeTrunk[] = [
  ...
  // Trunks from the hub out to each locked future-path cluster, radiating in a distinct compass direction.
